...
DB_URI = environ.get("DB_URI", "mongodb+srv://myDatabaseUser:D1fficultP%40ssw0rd@mongodb0.rahulwb.com/?authSource=admin&replicaSet=myRepl")
DB_NAME = environ.get("DB_NAME", "chatgptromiyobot")
